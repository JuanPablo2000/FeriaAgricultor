<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaPrincipalCliente.Master" AutoEventWireup="true" CodeBehind="PerfilCliente.aspx.cs" Inherits="Proyecto.views.Cliente.PerfilCliente" %>
              ...
              <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-md-5">
                        <div class="form-group">
                          <asp:Label ID="lblCedula" runat="server" Text="Nombre:" class="control-label col-md-2" ></asp:Label>
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                            <asp:Label ID="Label5" runat="server" Text="Telefóno:" class="control-label col-md-2" ></asp:Label>

<%@ Page Title="" Language="C#" MasterPageFile="~/Administrador.Master" AutoEventWireup="true" CodeBehind="Editar.aspx.cs" Inherits="Proyecto.views.Administrador.Vendedor.Editar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="form-group">
                 <asp:Label ID="Label3" runat="server" Text="Segundo Apellido:" class="control-label col-md-2" ></asp:Label>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                 <asp:Label ID="Label4" runat="server" Text="Identificación:" class="control-label col-md-2" ></asp:Label>
        ...
        <div class="col-md-6">
            <div class="form-group">
                 <asp:Label ID="Label5" runat="server" Text="Email:" class="control-label col-md-2" ></asp:Label>
    ...
    <br />
    <asp:Button runat="server" Text="Modificar Vendedor" class="btn btn-primary pull-right" OnClick="btnEditar" />
                      </div>
                    </div>
                </div>
            </div>

<%@ Page Title="" Language="C#" MasterPageFile="~/Administrador.Master" AutoEventWireup="true" CodeBehind="ListaTransportista.aspx.cs" Inherits="Proyecto.views.Administrador.Transportista.ListaTransportista" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Button ID="btnCrear" runat="server" Text="Crear Transportista" CssClass="btn btn-success" OnClick="btnCrear_Click" />
    <asp:GridView ID="gvTransportista" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#336666" BorderStyle="Double" BorderWidth="3px" CellPadding="4" GridLines="Horizontal" Width="487px" OnRowCommand="gvTransportista_RowCommand">
        <Columns>
            <asp:BoundField DataField="CEDULA" HeaderText="Cedula" SortExpression="CEDULA" />
            <asp:BoundField DataField="NOMBRE" HeaderText="Fecha" SortExpression="NOMBRE" />
            <asp:BoundField DataField="APELLIDO1" HeaderText="Apellido 1" SortExpression="APELLIDO1" />
            <asp:BoundField DataField="TELEFONO" HeaderText="Telefono" SortExpression="TELEFONO" />
            <asp:BoundField DataField="USUARIO" HeaderText="Usuario" SortExpression="USUARIO" />
            <asp:BoundField DataField="DISTRITO.NOMBRE_DISTRITO" HeaderText="Rol" SortExpression="ID_DISTRITO" />
